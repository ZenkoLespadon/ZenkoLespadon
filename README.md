...
Description: Development of an offline RAG chatbot with LangChain, Transformers, ChromaDB, and Ollama, including integration with a React/Node.js web interface and automated deployment on Ubuntu Server using Jenkins.
...
### SAE 2.04 — Advanced Database Design and Analysis (2023)
...
### SAE 1.04 — Database Design and SQL Analysis (2022)
Description: Design and implementation of a database from a CSV dataset, including data modeling, data import, SQL queries, and graphical analysis.
