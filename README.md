...
Description: Development of an offline RAG chatbot with a React and Node.js web interface, fully automated deployment on Ubuntu Server using Jenkins, and RAG integration with LangChain, Transformers, and ChromaDB.
